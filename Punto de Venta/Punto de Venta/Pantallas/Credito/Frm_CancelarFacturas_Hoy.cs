...
{
    public partial class Frm_CancelarFacturas_Hoy : Form
    {
        int Cliente = 0;
        public Frm_CancelarFacturas_Hoy(int ClienteID)
        {
            InitializeComponent();
            Cliente = ClienteID;
            CargarFacturasHOY();
        ...
        private void CargarFacturasHOY()
        {
            ...
            using (ServicioFactura elServicio = new ServicioFactura())
                dgvListadoHistorial.DataSource = elServicio.ListarFactHOYXcliente("", Cliente, 1);
            ...
            {
                MessageBox.Show("NO EXITEN FACTURAS PARA ESTE CLIENTE DE HOY");
                this.Close();
            }
        }
        ...
        private void btnCancelarFactura_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (ListViewItem elitem in lvItems.Items)
                {
                    ...
                    using (ServicioFactura elServicio = new ServicioFactura())
                        respuesta = elServicio.CancelarFacturasDE_HOY(int.Parse(elitem.SubItems[0].Text));
