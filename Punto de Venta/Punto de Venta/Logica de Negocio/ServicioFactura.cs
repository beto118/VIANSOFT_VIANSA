...
{
    class ServicioFactura : Servicio, IDisposable
    {
        ...
        public String EDITARFactura(int fact_numero, int Clie_ID, int Usuario_codigo, string Fact_Clie_Nombre, string Fact_Clie_Telefono, string Fact_Clie_Direccion, DateTime Fact_fecha, string Fact_estado, double Fact_subtotal, double Fact_descuento, double Fact_totalDescuento, double Fact_impuesto, double Fact_total, int Fact_Enviar)
        {
        ...
        {
            miComando.CommandText = "[SPR_Tbl_Factura_ActualizarTotales_2]";
        ...
        //modificar Facturas
        public String ModificarFactura(int fact_numero, int Clie_ID, string Fact_Clie_Nombre, string Fact_Clie_Telefono, string Fact_Clie_Direccion, double Fact_descuento, double Fact_totalDescuento, double Fact_subtotal, double Fact_impuesto, double Fact_total, int Fact_Enviar)//,double Fact_Utilidad
        {
            miComando.CommandText = "SPR_Tbl_Factura_ModificarTotales";
        ...
        {
            miComando.CommandText = "SPR_Tbl_LineaFactura_insertar_UPDATE_FACT";
        ...
        //Insertar Lineas
        public String RegistarLineaFactura(int fact_numero, int LinFact_prod_codigo, string LinFact_prod_nombre, double LinFact_prod_cantidad,double LinFact_prod_valorUnitario, double LinFact_prod_total, double LinFact_subtotal, double LinFact_impuesto, double LinFact_descuento,double LinFact_DescPorcent)
        {
            ...
            miComando.Parameters.Add("@LinFact_prod_total", SqlDbType.Money);
            miComando.Parameters["@LinFact_prod_total"].Value = LinFact_prod_total;
        ...
        //Insertar Lineas CUANDO SE EDITA UNA FACTURA
        public String RegistarLineaFactura_UPDATE_FACT(int fact_numero, int LinFact_prod_codigo, string LinFact_prod_nombre, double LinFact_prod_cantidad, double LinFact_prod_valorUnitario)//, double LinFact_Utilidad)//
        {
            miComando.CommandText = "[SPR_Tbl_LineaFactura_insertar_UPDATE_FACT]";
        ...
        public String RealizarAbonoDeFactura(int Fact_numero, double SaldoAnterior, double abono_Monto,double SaldoActual, string abono_Fecha, string abono_Detalle, int Usuario_ID)
        {
        ...
        public String RealizarAbonoDeHistFactura(int HistFact_numero, double SaldoAnterior, double abono_Monto, double SaldoActual, string abono_Fecha, string abono_Detalle, int Usuario_ID)
        {
        ...
        //Listar  Factura cred por cliente DE HOY
        public DataTable ListarFactHOYXcliente(string filtro, int Clie_ID, int ConSaldo)
        {
            miComando.CommandText = "[SPR_Tbl_Facturas_ListarXCliente]";
        ...
        //cancelar facturasx de hoy
        public String CancelarFacturasDE_HOY(int fact_numero)
        {
            miComando.CommandText = "[SPR_tbl_Factura_CancelarFacturas]";
